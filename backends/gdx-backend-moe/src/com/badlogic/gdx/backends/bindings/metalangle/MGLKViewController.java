...
public class MGLKViewController extends UIViewController implements MGLKViewDelegate {
	...
	public static native MGLKViewController allocWithZone (VoidPtr zone);
	...
	@Selector("new")
	@MappedReturn(ObjCObjectMapper.class)
	public static native MGLKViewController new_objc ();

	@Generated
	@Selector("pauseOnWillResignActive")
	public native boolean pauseOnWillResignActive ();

	/** The default value is 30. On iOS: - Setting to 0 or 1 will sync the framerate with display's refresh rate On macOS: -
	 * Setting to 1 will sync the framerate with display's refresh rate - Setting to 0 will display the frames as fast as
	 * possible. */
	@Generated
