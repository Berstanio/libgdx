...
public class MGLLayer extends CALayer {
	...
	public static native MGLLayer allocWithZone (VoidPtr zone);
	...
	/** Default OpenGL id of the framebuffer storing content of this layer. Might not necessary be zero. */
	@Generated
	...
	@Selector("new")
	@MappedReturn(ObjCObjectMapper.class)
	public static native MGLLayer new_objc ();
