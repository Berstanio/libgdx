...
public class MGLContext extends NSObject {
	...
	public static native MGLContext allocWithZone (VoidPtr zone);
	...
	/** NOTE: If you use sharegroup to share resources between contexts, make sure to call glFlush() when you finish the works of
	 * one context on a thread to make the changes visible to other contexts. */
	@Generated
	...
	@Selector("new")
	@MappedReturn(ObjCObjectMapper.class)
	public static native MGLContext new_objc ();
	...
	/** Set current context without layer. NOTE: this function is only useful if you want to create OpenGL resources such as
	 * textures/buffers before creating the presentation layer. Before drawing to a layer, use [MGLContext setCurrentContext:
