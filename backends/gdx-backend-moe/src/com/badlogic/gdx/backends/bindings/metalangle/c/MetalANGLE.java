...
public final class MetalANGLE {
	...
	@Generated
	@CFunction
	public static native void glCompressedTexImage2D (int target, int level, int internalformat, int width, int height, int border,
		int imageSize, ConstVoidPtr data);

	@Generated
	@CFunction
	public static native void glCompressedTexSubImage2D (int target, int level, int xoffset, int yoffset, int width, int height,
		int format, int imageSize, ConstVoidPtr data);

	@Generated
	@CFunction
	public static native void glCopyTexImage2D (int target, int level, int internalformat, int x, int y, int width, int height,
		int border);

	@Generated
	@CFunction
	public static native void glCopyTexSubImage2D (int target, int level, int xoffset, int yoffset, int x, int y, int width,
		int height);
	...
	@Generated
	@CFunction
	public static native void glGetActiveAttrib (int program, int index, int bufSize, IntPtr length, IntPtr size, IntPtr type,
		BytePtr name);

	@Generated
	@CFunction
	public static native void glGetActiveUniform (int program, int index, int bufSize, IntPtr length, IntPtr size, IntPtr type,
		BytePtr name);
	...
	@Generated
	@CFunction
	public static native void glGetShaderPrecisionFormat (int shadertype, int precisiontype, IntPtr range, IntPtr precision);
	...
	@Generated
	@CFunction
	public static native void glShaderBinary (int count, ConstIntPtr shaders, int binaryformat, ConstVoidPtr binary, int length);
	...
	@Generated
	@CFunction
	public static native void glTexSubImage2D (int target, int level, int xoffset, int yoffset, int width, int height, int format,
		int type, ConstVoidPtr pixels);
	...
	@Generated
	@CFunction
	public static native void glDrawRangeElements (int mode, int start, int end, int count, int type, ConstVoidPtr indices);
	...
	public static native void glTexSubImage3D (int target, int level, int xoffset, int yoffset, int zoffset, int width, int height,
		int depth, int format, int type, ConstVoidPtr pixels);

	@Generated
	@CFunction
	public static native void glCopyTexSubImage3D (int target, int level, int xoffset, int yoffset, int zoffset, int x, int y,
	...
	public static native void glCompressedTexSubImage3D (int target, int level, int xoffset, int yoffset, int zoffset, int width,
		int height, int depth, int format, int imageSize, ConstVoidPtr data);
	...
	@Generated
	@CFunction
	public static native void glBlitFramebuffer (int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1,
	...
	@Generated
	@CFunction
	public static native void glGetTransformFeedbackVarying (int program, int index, int bufSize, IntPtr length, IntPtr size,
	...
	@Generated
	@CFunction
	public static native void glCopyBufferSubData (int readTarget, int writeTarget, @NInt long readOffset, @NInt long writeOffset,
		@NInt long size);
	...
	@Generated
	@CFunction
	public static native void glGetActiveUniformsiv (int program, int uniformCount, ConstIntPtr uniformIndices, int pname,
		IntPtr params);
	...
	@Generated
	@CFunction
	public static native void glGetActiveUniformBlockName (int program, int uniformBlockIndex, int bufSize, IntPtr length,
		BytePtr uniformBlockName);
	...
	@Generated
	@CFunction
	public static native void glDrawElementsInstanced (int mode, int count, int type, ConstVoidPtr indices, int instancecount);
	...
	@Generated
	@CFunction
	public static native void glGetProgramBinary (int program, int bufSize, IntPtr length, IntPtr binaryFormat, VoidPtr binary);
	...
	@Generated
	@CFunction
	public static native void glInvalidateSubFramebuffer (int target, int numAttachments, ConstIntPtr attachments, int x, int y,
		int width, int height);
	...
	@Generated
	@CFunction
	public static native void glGetInternalformativ (int target, int internalformat, int pname, int bufSize, IntPtr params);
	...
	@Generated
	@CFunction
	public static native int eglChooseConfig (VoidPtr dpy, ConstIntPtr attrib_list, Ptr<VoidPtr> configs, int config_size,
		IntPtr num_config);
	...
	@Generated
	@CFunction
	public static native VoidPtr eglCreateContext (VoidPtr dpy, VoidPtr config, VoidPtr share_context, ConstIntPtr attrib_list);
	...
	@Generated
	@CFunction
	public static native VoidPtr eglCreatePixmapSurface (VoidPtr dpy, VoidPtr config, VoidPtr pixmap, ConstIntPtr attrib_list);

	@Generated
	@CFunction
	public static native VoidPtr eglCreateWindowSurface (VoidPtr dpy, VoidPtr config, VoidPtr win, ConstIntPtr attrib_list);
	...
	@Generated
	@CFunction
	public static native VoidPtr eglCreatePbufferFromClientBuffer (VoidPtr dpy, int buftype, VoidPtr buffer, VoidPtr config,
	...
	@Generated
	@CFunction
	public static native VoidPtr eglCreateImage (VoidPtr dpy, VoidPtr ctx, int target, VoidPtr buffer, ConstNIntPtr attrib_list);
