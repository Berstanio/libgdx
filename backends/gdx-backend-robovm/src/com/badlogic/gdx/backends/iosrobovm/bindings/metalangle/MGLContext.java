...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MGLContext/*</name>*/ 
    ...
    /*<ptr>*/public static class MGLContextPtr extends Ptr<MGLContext, MGLContextPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MGLContext.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MGLContext() {}
    protected MGLContext(Handle h, long handle) { super(h, handle); }
    protected MGLContext(SkipInit skipInit) { super(skipInit); }
    @Method(selector = "initWithAPI:")
    public MGLContext(MGLRenderingAPI api) { super((SkipInit) null); initObject(initWithAPI(api)); }
    @Method(selector = "initWithAPI:sharegroup:")
    public MGLContext(MGLRenderingAPI api, MGLSharegroup sharegroup) { super((SkipInit) null); initObject(initWithAPISharegroup(api, sharegroup)); }
    /*</constructors>*/
    /*<properties>*/
